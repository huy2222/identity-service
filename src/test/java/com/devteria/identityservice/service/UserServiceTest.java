...
public class UserServiceTest {
    ...
    void creatUser_validRequest_success() {
        ...
        // THEN
        Assertions.assertThat(response.getId()).isEqualTo("cd5151e0-1c2b-4f3a-9d5e-123456789abc");
        Assertions.assertThat(response.getUsername()).isEqualTo("join12345");
    }
    ...
    void getMyInfo_Invalid_error() {
        ...
        Assertions.assertThat(expection.getErrorCode().getCode()).isEqualTo(1005);
    }
}
